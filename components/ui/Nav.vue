  ...
  <nav class="hidden w-full p-0.5 md:inline-flex justify-between">
    <div class="w-1/3 p-0.5 inline-flex justify-between gap-6">
      <ul class="inline-flex gap-2.5">
        <li>
          <UiLink to="/"
            ><h6 class="font-medium uppercase">Theo Dupont</h6></UiLink
          >
        </li>
      </ul>
      ...
      <ul class="inline-flex gap-2.5">
        ...
        <li>
          <UiLink to="/experiments"
            ><h6 class="font-medium uppercase">Experiments</h6></UiLink
          >
        </li>
        <li>
          <UiLink to="/#contact" @click="$lenis.scrollTo('#contact')"
            ><h6 class="font-medium uppercase">Contact</h6></UiLink
          >
        </li>
      </ul>
    </div>
